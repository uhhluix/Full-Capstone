      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">      
         <a class="logoo" href="index.html">
            <img src="static/images/debuglogo.png" height="250px" alt="">
          </a>    
          <h2 class="text-center"> Log In To Debug IT<br>
           ${success} 
		   </h2>
          ...
          <form class="text-left clearfix" action="login" method="post" >
            ...
            <div class="text-center">
              <button type="submit" id="submiter" class="btn btn-main text-center" >Login</button>
            </div>
          </form>
